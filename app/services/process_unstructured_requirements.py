...
# ----- Main pipeline -----
def process_file(bucket_name, blob_name, local_path, size):
    # Step 1: Download
    ...
    for idx, req in enumerate(all_requirements):
        req["requirement_id"] = f"REQ-{idx+size+1:04d}"
...
def load_requirements():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        for blob in blobs:
            ...
            extracted_requirements.extend(process_file(GCS_BUCKET_NAME, blob.name, local_filename, len(extracted_requirements)))
